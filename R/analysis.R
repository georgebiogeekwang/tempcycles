...
#' from the \pkg{nlts} package. Warning: This is memory intensive and slow if
...
#' @param freq A vector of frequencies to test.
#' @return A "lomb" object with spectral power, freqency, phase, p (white
#'   noise), and tau (lag).
#' @export
#'
